...
function formatQuote(providerConf, params, data, eventId, isBest) {
    ...
    return {
        ...
        quoteResultCtx: { tx: data.tx, providerId: providerConf.id, isMock: false, ...data.ctx, fromAmount: params.fromTokenAmount, toAmount: data.toAmount, instantRate: rate, fee: { percentageFee: FEE_PERCENT * 100, estimatedFeeFiatValue: data.fiatFee || 0.1, protocolFees: 0 }, routesData: data.routesData, gasLimit: Number(data.tx?.gasLimit || 500000), fromTokenInfo: { contractAddress: params.fromTokenAddress || "", networkId: params.fromNetworkId, decimals: 18, symbol: "TOKEN" }, toTokenInfo: { contractAddress: params.toTokenAddress, networkId: params.toNetworkId, decimals: data.decimals || 18, symbol: "UNK" } },
    ...
    try {
        ...
        return res.json(ok({
            result: {
                ...
                gasLimit: quoteResultCtx.gasLimit
            },
            ctx: quoteResultCtx,
